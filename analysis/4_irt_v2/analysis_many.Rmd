...
d.some = read.csv("../../data/4_irt_v2//4_irt_v2-pilot-cond2-trials.csv")
d.many = read.csv("../../data/4_irt_v2//4_irt_v2-pilot-cond3-trials.csv")
...
d %>% 
  ...
  geom_errorbar(aes(ymin=p-low, ymax=p+high))
